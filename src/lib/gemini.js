...
6. pron 필드에서 조사와 어미는 반드시 **로 감싸서 강조해라. 이것은 매우 중요하다.
   - 조사 예: **오**, **가**, **와**, **니**, **에**, **데**, **노**, **모**, **도**, **카라**
   - 어미 예: **마스**, **마셍**, **데스**, **데스카**, **쿠다사이**, **마시타**, **마시타카**, **다**, **타이**, **테**
   - 실제 예시: "미즈**오** 쿠다사이." → "물을 주세요"
   - 실제 예시: "코레**와** 난**데스카**?" → "이것은 뭐예요?"
   - 실제 예시: "니혼고**가** 스키**데스**." → "일본어를 좋아합니다."
